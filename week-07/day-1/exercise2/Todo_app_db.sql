...
CREATE TABLE `doing` (
  `DoingID` int(11) NOT NULL AUTO_INCREMENT,
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `done` (
  `DoneID` int(11) NOT NULL AUTO_INCREMENT,
  `TaskID` int(11) NOT NULL,
  PRIMARY KEY (`DoneID`)
...
INSERT INTO `done` VALUES (1,1),(2,2);
...
INSERT INTO `tasks` VALUES (1,'Wake up'),(2,'Go to GF'),(3,'Survive'),(4,'Do some code'),(5,'Go home');
...
-- Dump completed on 2019-05-20 12:37:06

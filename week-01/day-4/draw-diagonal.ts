...
let numberOfSpacesInLines: number = lineCount - 3;
...
for (let i: number = 0; i < lineCount; i++){
  if (i === 0 || i === lineCount - 1){
    ...
    console.log('%' + repeater(lineBase, emptyElement, i - 1) + '%' + repeater(lineBase, emptyElement, numberOfSpacesInLines) + '%');
    numberOfSpacesInLines--;
  }
}
